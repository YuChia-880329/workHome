	...
	let diaryTextIdPrefix = 'diary_text_';
	let diaryHourIdPrefix = 'diary_hour_';
	let diaryTrIdPrefix = 'diary_tr_';
	...
	let diaryProjectTmplId = 'diary_project_tmpl';
	let diaryPhaseTmplId = 'diary_phase_tmpl';
	let diaryWorkTmplId = 'diary_work_tmpl';
	let diaryTextTmplId = 'diary_text_tmpl';
	let diaryHourTmplId = 'diary_hour_tmpl';
	let diaryTrTmplId = 'diary_tr_tmpl';
